...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_star_rating__ = __webpack_require__(35);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_Auth_Auth_js__ = __webpack_require__(36);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__routes__ = __webpack_require__(37);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_Includes_Constant__ = __webpack_require__(2);
...
Vue.use(__WEBPACK_IMPORTED_MODULE_1__components_Auth_Auth_js__["a" /* default */]);
Vue.component('star-rating', __WEBPACK_IMPORTED_MODULE_0_vue_star_rating___default.a);
Vue.use(__WEBPACK_IMPORTED_MODULE_3__components_Includes_Constant__["a" /* backendUrl */]);

// Vue.http.headers.common['Authorization'] = 'Bearer '+ Vue.auth.getToken();

var Myheader = __webpack_require__(63);
var Myfooter = __webpack_require__(66);

__WEBPACK_IMPORTED_MODULE_2__routes__["a" /* default */].beforeEach(function (to, form, next) {
    if (to.matched.some(function (record) {
        return record.meta.forVisitor;
    })) {
...
/* harmony default export */ __webpack_exports__["a"] = (function (Vue) {
    Vue.auth = {
        setToken: function setToken(token, expiry) {
...
var Profile = __webpack_require__(53);
var PageNotFound = __webpack_require__(56);

var routes = [{ path: '/', component: Home, name: 'home' }, { path: '/products', component: Products, name: 'products' }, { path: '/login', component: Login, meta: { forVisitor: true }, name: 'login' }, { path: '/register', component: Register, meta: { forVisitor: true }, name: 'register' }, { path: '/profile', component: Profile, meta: { forAuth: true }, name: 'profile' }, { path: '/:id/product', component: Product, name: 'product', props: true }, { path: "*", component: PageNotFound }];
...
Component.options.__file = "resources/assets/js/components/Contents/Home.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-6b23ec2d", Component.options)
  } else {
    hotAPI.reload("data-v-6b23ec2d", Component.options)
  }
...
var render = function() {
  ...
  return _c("div", { staticClass: "panel panel-body" }, [
    ...
    _vm._v(" "),
    _c("span", [
      _c("p", [_vm._v("Check out products")]),
      _vm._v(" "),
      _c(
        "small",
        [
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-6b23ec2d", module.exports)
  }
}
...
Component.options.__file = "resources/assets/js/components/Contents/Product/Products.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-5e1ad272", Component.options)
  } else {
    hotAPI.reload("data-v-5e1ad272", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Includes_Constant__ = __webpack_require__(2);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    data: function data() {
        return {
            products: {},
            imageLink: __WEBPACK_IMPORTED_MODULE_0__Includes_Constant__["a" /* backendUrl */] + '/storage/',
            productUrl: __WEBPACK_IMPORTED_MODULE_0__Includes_Constant__["a" /* backendUrl */] + '/api/products',
            pagination: {},
            meta: {}
        };
    },
    methods: {
        ...
        fetchProductsByNumber: function fetchProductsByNumber(number) {
            var productStaticUrl = __WEBPACK_IMPORTED_MODULE_0__Includes_Constant__["a" /* backendUrl */] + '/api/products';
        ...
        fetchPaginatedProducts: function fetchPaginatedProducts(url) {
            this.productUrl = url;
            this.fetchProducts();
        }
    },
        ...
        return _c("div", { staticClass: "col-md-4" }, [
          _c("div", { staticClass: "card", staticStyle: { width: "18rem" } }, [
            _c("img", {
              ...
              staticStyle: { height: "150px", width: "auto" },
              attrs: {
                src: _vm.imageLink + product.image_path,
                alt: product.image
              }
            }),
            _vm._v(" "),
    ...
    _c("div", { staticClass: "pagination" }, [
      _c("nav", { attrs: { "aria-label": "Page navigation example" } }, [
        _c(
          ...
          [
            _vm.meta.last_page > 1 && _vm.meta.from != _vm.meta.current_page
              ? [
                  _c("li", { staticClass: "page-item" }, [
                    _c(
                      "a",
                      {
                        ...
                        attrs: { disabled: !_vm.pagination.first_page },
                        on: {
                          click: function($event) {
                            _vm.fetchPaginatedProducts(
            ...
            _vm.meta.last_page > 1
              ? _vm._l(_vm.meta.last_page, function(pageNo) {
                  return _c(
                    "li",
                    {
                      staticClass: "page-item",
                      class: { active: pageNo === _vm.meta.current_page }
                    },
                    [
                      _c(
                        "a",
                        {
                          staticClass: "page-link",
                          attrs: { disabled: !pageNo },
                          on: {
                            click: function($event) {
                              _vm.fetchProductsByNumber(pageNo)
                            }
                          }
                        },
            ...
            _vm._v(" "),
            _vm.meta.last_page > 1 &&
            _vm.meta.last_page != _vm.meta.current_page
              ? [
                  _c("li", { staticClass: "page-item" }, [
                    _c(
                      "a",
                      {
                        staticClass: "page-link",
                        attrs: { disabled: !_vm.pagination.last_page },
                        on: {
                          click: function($event) {
                            _vm.fetchPaginatedProducts(_vm.pagination.last_page)
                          }
                        }
                      },
                      [
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-5e1ad272", module.exports)
  }
}
...
Component.options.__file = "resources/assets/js/components/Contents/Product/Product.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-e1642e5e", Component.options)
  } else {
    hotAPI.reload("data-v-e1642e5e", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        getProduct: function getProduct() {
            ...
            var url = __WEBPACK_IMPORTED_MODULE_0__Includes_Constant__["a" /* backendUrl */] + '/api/products/' + id;
            var self = this;
            axios.get(url).then(function (response) {
                // console.log(response.data.data);
                _this.product = response.data.data;
                _this.imageLink = __WEBPACK_IMPORTED_MODULE_0__Includes_Constant__["a" /* backendUrl */] + '/storage/' + response.data.data.image_path;
                console.log(response.data.data.reviewsRating);
                var href = response.data.data.href.reviews;
                self.getReviews(href);
            });
        },
        getReviews: function getReviews(href) {
            var _this2 = this;
      ...
      _c("div", { staticClass: "row" }, [
        _c("div", { staticClass: "col-md-5" }, [
          _c("img", {
            ...
            attrs: { src: _vm.imageLink, alt: _vm.product.image }
          }),
          _vm._v(" "),
          _c("br"),
          _vm._v(" "),
        ...
        _c(
          "div",
          {
            ...
            staticStyle: { border: "0px solid gray" }
          },
          [
            ...
            _c(
              "div",
              {
                staticStyle: { width: "100%", "border-top": "1px solid silver" }
              },
              [
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("h6", { staticClass: "title-price" }, [
      _c("small", [_vm._v("Price")])
    ])
  },
  function() {
    var _vm = this
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-e1642e5e", module.exports)
  }
}
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        login: function login() {
            ...
            var url = __WEBPACK_IMPORTED_MODULE_0__Includes_Constant__["a" /* backendUrl */] + "/oauth/token";
            var item = {
                grant_type: "password",
                client_id: "2",
              ...
              directives: [
                {
                  name: "model",
                  rawName: "v-model",
                  value: _vm.loginItem.email,
                  expression: "loginItem.email"
                }
              ],
              staticClass: "form-control",
              attrs: { type: "email", placeholder: "Email" },
              domProps: { value: _vm.loginItem.email },
              on: {
                input: function($event) {
                  if ($event.target.composing) {
                    return
                  }
                  _vm.$set(_vm.loginItem, "email", $event.target.value)
                }
              }
            })
          ]),
              ...
              directives: [
                {
                  name: "model",
                  rawName: "v-model",
                  value: _vm.loginItem.password,
                  expression: "loginItem.password"
                }
              ],
              staticClass: "form-control",
              attrs: { type: "password", placeholder: "Password" },
              domProps: { value: _vm.loginItem.password },
              on: {
                input: function($event) {
                  if ($event.target.composing) {
                    return
                  }
                  _vm.$set(_vm.loginItem, "password", $event.target.value)
                }
              }
            })
          ]),
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        register: function register() {
            ...
            var url = __WEBPACK_IMPORTED_MODULE_0__Includes_Constant__["a" /* backendUrl */] + "/api/register";
            this.userError = "";
            axios.post(url, this.userItem).then(function (response) {
              ...
              directives: [
                {
                  name: "model",
                  rawName: "v-model",
                  value: _vm.userItem.username,
                  expression: "userItem.username"
                }
              ],
              staticClass: "form-control",
              attrs: { type: "text" },
              domProps: { value: _vm.userItem.username },
              on: {
                input: function($event) {
                  if ($event.target.composing) {
                    return
                  }
                  _vm.$set(_vm.userItem, "username", $event.target.value)
                }
              }
            }),
            _vm._v(" "),
            _vm._l(_vm.userError.username, function(usernameError) {
              return _vm.userError.username
                ? _c("span", [
                    _c("ul", [_c("li", [_vm._v(_vm._s(usernameError))])])
                  ])
                : _vm._e()
            })
          ],
        ...
        _c(
          ...
          [
            ...
            _c("input", {
              ...
              staticClass: "form-control",
              attrs: { type: "email" },
              domProps: { value: _vm.userItem.email },
              on: {
                input: function($event) {
                  if ($event.target.composing) {
                    return
                  }
                  _vm.$set(_vm.userItem, "email", $event.target.value)
                }
              }
            }),
            _vm._v(" "),
            _vm._l(_vm.userError.email, function(emailError) {
              return _vm.userError.email
                ? _c("span", [
                    _c("ul", [_c("li", [_vm._v(_vm._s(emailError))])])
                  ])
                : _vm._e()
            })
          ],
        ...
        _c(
          ...
          [
            ...
            _c("input", {
              ...
              staticClass: "form-control",
              attrs: { type: "text" },
              domProps: { value: _vm.userItem.name },
              on: {
                input: function($event) {
                  if ($event.target.composing) {
                    return
                  }
                  _vm.$set(_vm.userItem, "name", $event.target.value)
                }
              }
            }),
            _vm._v(" "),
            _vm._l(_vm.userError.name, function(nameError) {
              return _vm.userError.name
                ? _c("span", [
                    _c("ul", [_c("li", [_vm._v(_vm._s(nameError))])])
                  ])
                : _vm._e()
            })
          ],
              ...
              directives: [
                {
                  name: "model",
                  rawName: "v-model",
                  value: _vm.userItem.password,
                  expression: "userItem.password"
                }
              ],
              staticClass: "form-control",
              attrs: { type: "password" },
              domProps: { value: _vm.userItem.password },
              on: {
                input: function($event) {
                  if ($event.target.composing) {
                    return
                  }
                  _vm.$set(_vm.userItem, "password", $event.target.value)
                }
              }
            }),
            _vm._v(" "),
            _vm._l(_vm.userError.password, function(passwordError) {
              return _vm.userError.password
                ? _c("span", [
                    _c("ul", [_c("li", [_vm._v(_vm._s(passwordError))])])
                  ])
                : _vm._e()
            })
          ],
...
Component.options.__file = "resources/assets/js/components/Contents/Users/Profile.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-fd8ad2b8", Component.options)
  } else {
    hotAPI.reload("data-v-fd8ad2b8", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        getUser: function getUser() {
            ...
            var url = __WEBPACK_IMPORTED_MODULE_0__Includes_Constant__["a" /* backendUrl */] + "/api/user";
            var Auth = "Bearer " + this.$auth.getToken();
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-fd8ad2b8", module.exports)
  }
}
...
var update = __webpack_require__(60)("6dadca6c", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-4f553a56\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./PageNotFound.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-4f553a56\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./PageNotFound.vue");
...
var staticRenderFns = [
  function() {
    ...
    return _c("div", { staticClass: "error" }, [
      _c("div", { staticClass: "container-floud" }, [
        _c("div", { staticClass: "col-xs-12 ground-color text-center" }, [
          _c("div", { staticClass: "container-error-404" }, [
            _c("div", { staticClass: "clip" }, [
              _c("div", { staticClass: "shadow" }, [
                _c("span", { staticClass: "digit thirdDigit" }, [_vm._v("4")])
              ])
            ]),
            _vm._v(" "),
            _c("div", { staticClass: "clip" }, [
              _c("div", { staticClass: "shadow" }, [
                _c("span", { staticClass: "digit secondDigit" }, [_vm._v("0")])
              ])
            ]),
            _vm._v(" "),
            _c("div", { staticClass: "clip" }, [
              _c("div", { staticClass: "shadow" }, [
                _c("span", { staticClass: "digit firstDigit" }, [_vm._v("4")])
              ])
            ]),
            _vm._v(" "),
          ...
          _vm._v(" "),
          _c("h2", { staticClass: "h1" }, [_vm._v("Sorry! Page not found")])
        ])
      ])
    ])
  }
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-09e0ac96"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __vue_script__,
...
Component.options.__file = "resources/assets/js/components/Includes/MyHeader.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-09e0ac96", Component.options)
  } else {
    hotAPI.reload("data-v-09e0ac96", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
Component.options.__file = "resources/assets/js/components/Includes/MyFooter.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-2ea36eb8", Component.options)
  } else {
    hotAPI.reload("data-v-2ea36eb8", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
    data: function data() {
        ...
        return {
            username: 'Sanjay Khadka',
            website: 'https://github.com/khadka7/laravel-vue',
            date: fullYear
        };
    }
});
...
var render = function() {
  ...
  return _c(
    "footer",
    { staticClass: "container-fluid text-center bg-lightgray" },
    [
      _c(
        "div",
        { staticClass: "copyrights", staticStyle: { "margin-top": "25px" } },
        [
          _c("p", [
            _vm._v(
              _vm._s(_vm.username) +
            ...
            _c("br"),
            _vm._v(" "),
            _c("span", [_vm._v("Web Developed By: " + _vm._s(_vm.username))])
          ]),
          _vm._v(" "),
          _c("p", [
            _c("a", { attrs: { href: _vm.website, target: "_blank" } }, [
              _vm._v("Github \n                "),
              _c("i", {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-2ea36eb8", module.exports)
  }
}
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(60)("794ed77a", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-09e0ac96\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./MyHeader.vue", function() {
     var newContent = require("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-09e0ac96\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./MyHeader.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
// module
exports.push([module.i, "\n.router-link-exact-active[data-v-09e0ac96]{\n    -webkit-text-decoration: #636b6f;\n            text-decoration: #636b6f;\n    font-weight: bold;\n}\n", ""]);
                      ...
                      _c("li", { staticClass: "nav-item" }, [
                        _c(
                          ...
                          [
                            _vm._v(
                              "\n                             " +
                                _vm._s(_vm._f("capitalize")(content)) +
                                "\n                        "
                            )
                          ]
                        )
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-09e0ac96", module.exports)
  }
}
